...
# 文件: 
soup2 = BeautifulSoup(open("baidu.html"), "lxml")
```
...
# ---------其他-----------
a_Tag = a_tags[0]	# a标签集合中，第一个a标签
text = a_Tag.text	# 标签内容
url = a_Tag.attrs["href"]	# a标签href值

# 获取某个元素的父节点
a_Tag.parent

# 获取某个元素的兄弟节点
a_Tag.next_sibling		# 后一个
a_Tag.previous_sibling	# 前一个
